...
route.put('/like/:id', auth, async (req,res) => {
    try {
        ...
        //check if the post has already bee liked
...
//Post that text reply then Comment user
...
//delelte the comment commment/:id
